...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.asthtc.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".asthtc" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".asthtc")
	}
