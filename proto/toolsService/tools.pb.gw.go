...
/*
Package toolsService is a reverse proxy.
...
func request_Tools_Voweless_0(ctx context.Context, marshaler runtime.Marshaler, client ToolsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq VowelessJob
	...
	msg, err := client.Voweless(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterToolsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ToolsClient) error {
	...
	mux.Handle("POST", pattern_Tools_Voweless_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Tools_Voweless_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Tools_Voweless_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Tools_Voweless_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "voweless"}, ""))
)

var (
	forward_Tools_Voweless_0 = runtime.ForwardResponseMessage
)
